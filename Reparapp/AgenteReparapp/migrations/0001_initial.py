    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('RE', 'Reparado'), ('RC', 'Recepcionado'), ('ER', 'En Reparación'), ('IN', 'Informada'), ('CE', 'Cerrada')], default='RE', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecnicoEspecialista', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AdminReparapp.tecnicoespecialista')),
            ],
            options={
